...
echo. app_image_builder_postFetch.exe Debug\List\app.map Debug\Exe\app.bin ..bin\gs2000_app.bin

app_image_builder_postFetch.exe Debug\List\app.map Debug\Exe\app.bin ..\bin\gs2000_app.bin
...
:SINGLEIMAGE
..\..\..\tools\GS_programming_tool\DOS_Files\gs_flashprogram.exe -c1 -n1 -1 ..\bin\gs2000_SingleImage.bin -2 ..\..\..\tools\Super_Control_block\superblock_4MB_3_Copy.bin -S%comport% -v
