...
GSN_STATUS  
App_MdnsSrvcReg(GSN_MDNS_T *pMdns);
                                  ...
                                  UINT32 status)
{
    ...
    {
        AppMainCtx_TaskNotify(APP_EVENT_START_SERVICE_DISCOVER,0);
    }
...
void App_StartServiceDiscovery(PROXY_UPDATER_DATA *proxyUpdater,GSN_MDNS_T *mdns)
{
    ...
    AppDbg_Printf("App_StartServiceDiscovery +\r\n");
    ...
    AppDbg_Printf("semaphore released,serviceDiscovered =  %d\r\n",serviceDiscovered);
