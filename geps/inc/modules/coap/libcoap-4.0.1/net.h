...
//#include <netinet/in.h> 	/* GainSpan Modified */
#endif
#ifdef HAVE_TIME_H
#include <time.h>
#endif
#ifdef HAVE_SYS_TIME_H
//#include <sys/time.h> 	/* GainSpan Modified */
#endif

#include "modules/coap/libcoap-4.0.1/option.h"
#include "modules/coap/libcoap-4.0.1/address.h"
#include "modules/coap/libcoap-4.0.1/prng.h"
#include "modules/coap/libcoap-4.0.1/pdu.h"
#include "modules/coap/libcoap-4.0.1/coap_time.h"
...
typedef struct coap_queue_t {
  ...
  unsigned long long timeout;		/* the randomized timeout value */ 	/* GainSpan Modified */
...
#ifndef WITH_CONTIKI
  context->message_id = (context->message_id) + 1 ; /* GainSpan Modified */ /* fixed coverity issue of Evaluation order violation */
  return htons(context->message_id); 	/* GainSpan Modified */
#else /* WITH_CONTIKI */
