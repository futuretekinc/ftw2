...
*
* $RCSfile: gsn_wpa_authif.h,v $
*
* Description : This file contains the private declaration used for supplicant
* modules.
*******************************************************************************/
#ifndef _GSN_WPA_AUTHIF_H_
#define _GSN_WPA_AUTHIF_H_
 ...
 *******************************************************************************/
PUBLIC VOID*
GsnWpaAuthIf_Init( VOID* pCtx, GSN_WPAIF_MODE_T mode, VOID *pDrvIf,
