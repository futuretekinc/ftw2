...
#define TLS_VERSION_1_1 0x0302 /* TLSv1.1 = 0x0302 */
#define TLS_VERSION_1_2 0x0303 /* TLSv1.2 = 0x0303 */
...
int tlsv12_prf(const u8 *secret, size_t secret_len, const char *label,
