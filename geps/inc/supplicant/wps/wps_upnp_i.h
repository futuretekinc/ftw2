...
struct advertisement_state_machine {
	...
	int state;
	int nerrors;
	//struct sockaddr_in client; /*GAINSPAN commented*//* for M-SEARCH replies */TODO GAINSPAN commented
};
...
struct subscr_addr {
	...
	//struct sockaddr_in saddr; /*GAINSPAN commented*//* address for doing connect */
...
struct subscription {
	...
	unsigned long timeout_time; /* when to age out the subscription */
