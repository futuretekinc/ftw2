...
*
* $RCSfile: gsn_version.h,v $
*
* Description : This file contains the GSN version.
******************************************************************************/
#ifndef _GSN_VERSION_H_
#define _GSN_VERSION_H_
 ...
 * @brief GSN Version.
 *
 *    This file contains version information for the release in use.
 *****************************************************************************/
UINT32 GsnVersion_Get(VOID);
...
/**
 ******************************************************************************
 * @defgroup GsnVersion GSN Version
 * @brief This module contains GEPS version number definitions.
 *****************************************************************************/
 ...
 ******************************************************************************
 * @ingroup GsnVersion
 * @brief Gainspan Chip/Module name 
 *
 *	  This macro defines the gainspan chip version 
 *****************************************************************************/
#define GSN_CHIP_VERSION   "gs2000"
 ...
 *****************************************************************************/
#define GSN_BUILD_VERSION 5	
#define GSN_EXT_BUILD_VERSION 10
/**
 ******************************************************************************
 * @ingroup GsnVersion
 * @brief GSN Version.
...
#define GSN_PLATFORM_VERSION (( GSN_MAJOR_VERSION << 24 ) | \
    ( GSN_MINOR_VERSION << 16 ) | (GSN_BUILD_VERSION << 8) | GSN_EXT_BUILD_VERSION  )

#ifdef __cplusplus
}
#endif

#endif /* _GSN_VERSION_H_ */
