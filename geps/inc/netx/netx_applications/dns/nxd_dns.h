...
#define NX_DNS_RESP_TTL_OFFSET			06
...
UINT _nx_dns_create_patch(NX_DNS *dns_ptr, NX_IP *ip_ptr, UCHAR *domain_name);
UINT  _nx_dns_packet_pool_set_patch(NX_DNS *dns_ptr, NX_PACKET_POOL *packet_pool_ptr);
UINT  _nx_dns_host_by_name_get_patch(NX_DNS *dns_ptr, UCHAR *host_name_ptr, ULONG *dns_address, ULONG wait_option);
