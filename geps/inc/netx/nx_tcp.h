...
#define NX_TCP_KEEPALIVE_INITIAL    30 /*7200*/            /* Number of seconds for initial */ 
#endif                                              /*   keepalive expiration, the   */ 
                                                    /*   default is 2 hours (120 min)*/ 
#ifndef NX_TCP_KEEPALIVE_RETRY  
#define NX_TCP_KEEPALIVE_RETRY      30/*75*/              /* After initial expiration,     */ 
...
VOID  _nx_tcp_socket_packet_process_patch(NX_TCP_SOCKET *socket_ptr, NX_PACKET *packet_ptr);
...
UINT  _nx_tcp_socket_state_ack_check_patch(NX_TCP_SOCKET *socket_ptr, NX_TCP_HEADER *tcp_header_ptr);
...
UINT  _nxe_tcp_socket_disconnect_patch(NX_TCP_SOCKET *socket_ptr, ULONG wait_option);
