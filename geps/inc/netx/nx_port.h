...
/*                                                                        */ 
/*  01-28-2011     Yuxin Zhou               Initial NetX Duo 5.0 Cortex-M3*/ 
/*                                            Support for IAR             */ 
...
#define NX_IP_PERIODIC_RATE 10             /* Default IP periodic rate of 1 second for 
                                               ...
                                               /*
                                               	Gainspan:
                                               		changed value for 100 mSec Timer interrupt
												*/
#endif
...
CHAR                            _nx_version_id[] = 
                                    "Copyright (c) 1996-2013 Express Logic Inc. * NetX Duo Cortex-M3/IAR Version G5.7.5.3 SN: 3412-108-0915 *";
#else
