...
#ifndef FTW_HAL_SPECIFIC_H
#define FTW_HAL_SPECIFIC_H
...
#define FTW_HAL_GAINSPAN_SERIAL_BUFFER_SIZE 4096

/** Default channels to scan */
#define FTW_HAL_GAINSPAN_DEFAULT_CHANNELS MAC_CHANNELDOMAIN_X10_24GHZ

/** Default channel to start ad-hoc network on */
#define FTW_HAL_GAINSPAN_DEFAULT_ADHOC_CHANNEL 6
