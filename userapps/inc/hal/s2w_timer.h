 ...
 * @retval VOID
 ******************************************************************/
VOID AppS2wHal_TimerInit(FTW_TIMER_T *timer, VOID (*handler)(VOID *), VOID *data);
 ...
 * @retval VOID
 ******************************************************************/
VOID AppS2wHal_TimerStart(FTW_TIMER_T *timer, UINT32 timeout);
 ...
 * @retval VOID
 ******************************************************************/
GSN_STATUS AppS2wHal_TimerStop(FTW_TIMER_T *timer);
 ...
 * @retval VOID
 ******************************************************************/
VOID AppS2wHal_TimerDelete(FTW_TIMER_T *timer);
