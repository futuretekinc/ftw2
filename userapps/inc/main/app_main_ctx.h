...
typedef enum FTW_SERIAL_PORT_ID
{
	FTW_PORT_UART,
	FTW_PORT_SPI,
        FTW_PORT_FS_SPI,
	FTW_PORT_SDIO
}FTW_SERIAL_PORT_ID_T;
...
typedef struct APP_MAIN_CTX
{
    ...
    FTW_SERIAL_PORT_ID_T   serialDeviceId;     /* 0 - UART   1- SPI interface */
...
#endif
#if 1//defined(FTW_WEB_PROV) || defined(GSN_WEB_SERVER)
	FTW_WBSERVER_CONFIG_T WebServerCfg;
...
UINT32 s2wUamBufQBuf[FTW_NUM_UAM_BUFS+1];
#endif
#ifdef FTW_SNTP
...
UINT8 l2ConfigBitField;
   ...
   FTW_SERIAL_PORT_ID_T   serialDeviceId1;
#endif
UINT8 logLevel;
