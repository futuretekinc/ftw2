 ...
 ****************************************************************************/
// XTRA
#define FTW_DEFAULT_UART_BAUD           115200
#define FTW_DEFAULT_UART_BITS_PER_CHAR  3
#define FTW_DEFAULT_UART_PARITY         0
#define FTW_DEFAULT_UART_STOP_BITS      0
#define FTW_DEFAULT_UART_SW_FLOW        0
#define FTW_DEFAULT_UART_HW_FLOW        0

/* default bin type
 */
#define FTW_BIN_TYPE "GS2K_DEFAULT"
/* default mode
 */
#define FTW_DEFAULT_WLAN_MODE 1

/* wlan station specific
 */
//#define  FTW_DEFAULT_STA_MAC_ADDR_VALID           0
     //static const UINT8 FTW_DEFAULT_STA_MAC_ADDR[6] ={0x00, 0x1d, 0xc9, 0x00, 0x00, 0x00};

#define FTW_DEFAULT_AC_WLAN_SSID "GSDemoKit"
#define FTW_DEFAULT_AC_WLAN_CHANNEL 1
#define FTW_DEFAULT_REG_DOMAIN 0
//#define FTW_DEFAULT_WLAN_MODE_RATE       0
//#define FTW_DEFAULT_AC_WLAN_BSSID_VALID  0  // 0->not valid
    //static const UINT8 FTW_DEFAULT_AC_WLAN_BSSID[6] =     {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define FTW_DEFAULT_SECURITY 0

//#define FTW_DEFAULT_WEP_AUTH_MODE        1   //1-->open , 2 -->shared
//#define FTW_DEFAULT_WEP_KEY_ID           1   // 1 to 4
//#define FTW_DEFAULT_WEP_KEY_LEN          5   // 5 or 13
    //static const UINT8 FTW_DEFAULT_WEP_KEY[FTW_DEFAULT_WEP_KEY_LEN] ={0x12, 0x34, 0x56, 0x78, 0x90};
//wpa
//#define FTW_DEFAULT_WPA_PASSPHRASE     "Serial2Wifi"
//#define FTW_DEFAULT_AP_WPA_PASSPHRASE     "Serial2Wifi"

//Eap

//#define FTW_DEFAULT_EAP_INNERAUTH     0
//#define FTW_DEFAULT_EAP_OUTERAUTH     0
//#define FTW_DEFAULT_EAP_USERNAME         "GSDemoKit"
//#define FTW_DEFAULT_EAP_PWD              "GSDemoKit"
//#define FTW_DEFAULT_EAP_USE_CA_CERT	 0
//#define FTW_DEFAULT_NODE_TIME_SET         0  // 0- not set, 1-> set
//#define FTW_DEFAULT_NODE_TIME 0

#define FTW_DEFAULT_MAC_ACK_MISS_COUNT 20
#define FTW_DEFAULT_RETRY_COUNT 8
#define FTW_DEFAULT_SCAN_MIN_TIME 150

//#define FTW_DEFAULT_STRICT_SECURITY      0  //0-> disable // this we can remove...

#define FTW_DEFAULT_MCAST_RX 1
#define FTW_DEFAULT_POWER_SAVE 1
#define FTW_DEFAULT_RADIO_MODE 0
#define FTW_DEFAULT_SYNCLOSS_INTERVAL 100
//#define FTW_DEFAULT_LISTEN_INTERVAL      100 // msec
#define FTW_DEFAULT_KEEPALIVE_INTERVAL 45

#define FTW_DEFAULT_USE_DHCP 1
...
//#define FTW_DEFAULT_GRP_PROV_SSID         "GSDemoKit"
//#define FTW_DEFAULT_GRP_PROV_CHANNEL      1
//#define FTW_DEFAULT_GRP_PROV_REG_DOMAIN        0  // 0->fcc, 1->etsi, 2->telec 
...
//#define FTW_DEFAULT_GRP_PROV_HOST_NAME            "GAINSPAN"
...
//#define  FTW_DEFAULT_AP_MAC_ADDR_VALID           0
    //static const UINT8 FTW_DEFAULT_AP_MAC_ADDR[6] ={0x00, 0x1d, 0xc9, 0x00, 0x00, 0x00};
#define FTW_DEFAULT_AP_WLAN_SSID "GSDemoKit"
#define FTW_DEFAULT_AP_WLAN_CHANNEL 1
#define FTW_DEFAULT_AP_REG_DOMAIN 0
//#define FTW_DEFAULT_AP_WLAN_BSSID_VALID  0  // 0->not valid
   //static const UINT8 FTW_DEFAULT_AP_WLAN_BSSID[6] =     {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define FTW_DEFAULT_AP_BEACON_INTERVAL 100
#define FTW_DEFAULT_AP_SSID_BROADCAST 0
#define FTW_DEFAULT_AP_SECURITY 1
#define FTW_DEFAULT_AP_MAC_FILTER 0
#define FTW_DEFAULT_AP_SUPPORTED_STATIONS 64
...
//#define FTW_DFLT_AP_USERNAME             "admin"
//#define FTW_DFLT_AP_PWD                  "admin"
/* Ncm Specific
 */
#define FTW_DEFAULT_AUTO_START 0
#define FTW_NCM_DFLT_CPUWAIT_PERIOD 1000
...
#define FTW_NCM_DFLT_L4CONNECT_PERIOD 1000
#define FTW_NCM_DFLT_L4CONNECT_COUNT 100

#define FTW_NCM_DFLT_ROAMING 0
//#define FTW_NCM_DFLT_ROAMING_LOW_RSSI_THRESH    70  //db
//#define FTW_NCM_DFLT_ROAMING_HIGH_RSSI_THRESH   50  // db
//#define FTW_NCM_DFLT_ROAMING_BACKGROUND_SCAN_TIME   1000 //msec

#define FTW_DFLT_AP_DHCPSRVR_LEASE_TIME 86400
#define FTW_DFLT_AP_DNS_IP1 MAKEIP(192,168,240,1)
#define FTW_DFLT_AP_DNS_IP2 MAKEIP(192,168,240,1)
#define FTW_DFLT_AP_DNS_IP3 MAKEIP(192,168,240,1)

//#define FTW_DFLT_MDNS_HOST_NAME
#define FTW_DFLT_MDNS_DOMAIN_NAME "local"
//#define FTW_DFLT_MDNS_SER_INST_NAME
//#define FTW_DFLT_MDNS_SER_SUB_TYPE
#define FTW_DFLT_MDNS_SER_TYPE "_http"
#define FTW_DFLT_MDNS_PROTO "_tcp"
//#define FTW_DFLT_MDNS_PORT
#define FTW_DFLT_MDNS_KEY 0
//#define FTW_DFLT_MDNS_TXT_RECORD
#define FTW_DFLT_MDNS_AUTOCORRECT 0
#define FTW_DFLT_MDNS_SCOPE 0
#define FTW_DFLT_MDNS_CONFLICT_DETECT 1
#define FTW_DFLT_MDNS_TTL 10


//#define FTW_DFLT_HTTPC_AUTH                "12345676890"
#define FTW_DFLT_HTTPC_HOST_IP "192.168.240.1"

#define FTW_DFLT_SNTP_SVR_IP MAKEIP(192,168,240,1)
#define FTW_DFLT_SNTP_TIMEOUT 1000
#define FTW_DFLT_SNTP_PERIODIC 0
#define FTW_DFLT_SNTP_PERIODIC_PERIOD 10

//#define FTW_DFLT_HTTP_SRVR_USRNAME
//#define FTW_DFLT_HTTP_SRVR_PWD
//#define FTW_DFLT_HTTP_SRVR_URI
#define FTW_DFLT_HTTP_SRVR_CONTENT_TYPE 0
#define FTW_DFLT_HTTP_SRVR_CLIENT_NO 8
#define FTW_DFLT_HTTP_SRVR_IDLE_TIMEOUT 120

#define FTW_DFLT_OTAFU_PULL_SRVR_IP MAKEIP(192,168,240,1)
//#define FTW_DFLT_OTAFU_PULL_SRVR_PORT      8
#define FTW_DFLT_OTAFU_PULL_PROXY_SRVR 0
//#define FTW_DFLT_OTAFU_PULL_PROXY_SRVR_IP      0
//#define FTW_DFLT_OTAFU_PULL_PROXY_SRVR_PORT      0
//#define FTW_DFLT_OTAFU_PULL_BIN_URL      8
#define FTW_DFLT_OTAFU_PULL_SSL 0

//#define FTW_DFLT_OTAFU_UPDATE_OPTIONS          0 //1-->bkp,2-->factory restore ,0-->no copy
#define FTW_DFLT_OTAFU_UPDATE_INTERFACE 0

//#define FTW_FACT_IMAGE_REQ

#define FTW_DFLT_IEEE_PS_CFG_WAKEUP_TYPE 3
#define FTW_DFLT_IEEE_PS_CFG_WAKEUP_INTERVAL 1
//#define FTW_DFLT_IEEE_PS_CFG_LISTN_INTVL_ASSOC          5
//#define FTW_DFLT_IEEE_PS_CFG_DATA_RX_TYPE               1 /*GSN_WIF_WLAN_STA_PS_DATA_RX_TYPE_PS_POLL*/
#define FTW_DFLT_IEEE_PS_CFG_ENABLE 0
...
#define FTW_WEB_IMAGE_SECTOR_SIZE 512
