...
*******************************************************************************/
#ifndef _FTW_WEB_PROV_H_
#define _FTW_WEB_PROV_H_
PUBLIC UINT32
...
typedef enum INPUT_ERROR
{
 ...
 typedef enum FTW_WEB_STORE_PARAMS
{
	FTW_WEB_PARAMS_SND_TO_HOST,
	FTW_WEB_PARAMS_STORE,
	FTW_WEB_PARAMS_SND_AND_STORE
}FTW_WEB_STORE_PARAMS_T;
