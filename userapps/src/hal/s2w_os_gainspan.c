...
PUBLIC VOID
AppS2wHal_TimerInit(FTW_TIMER_T * timer, VOID (*handler) (VOID *), VOID *data)
{
    FTW_ASSERT(handler != NULL);

    //memset(&timer->timer, 0, sizeof(FTW_TIMER_T));
    timer->timeout = 0;
 ...
 ******************************************************************/
PUBLIC VOID
AppS2wHal_TimerStart(FTW_TIMER_T * timer, UINT32 timeout)
{
    if (timeout == 0)
    {
        return;
 ...
 ******************************************************************/
PUBLIC GSN_STATUS
AppS2wHal_TimerStop(FTW_TIMER_T * timer)
{
 ...
 ******************************************************************/
PUBLIC VOID
AppS2wHal_TimerDelete(FTW_TIMER_T * timer)
{
    timer->handle = NULL;
