...
GSN_BYTE_POOL_LINK_T bytePool[5];

#define WORD_ALIGNED_ADDR(a)	(((a) & (~0x3)) + 0x4)

#define REUSE_ROM_REGION_1_START      0x20006f49//(((0x20006f49) & (~0x3)) + 0x4)
#define REUSE_ROM_REGION_1_END        0x2000ae88//(((0x20006f49) & (~0x3)) + 0x4)

#define REUSE_ROM_REGION_2_START      0x2000b7a5//(((0x200067a5) & (~0x3)) + 0x4)
#define REUSE_ROM_REGION_2_END        0x2000fb2c//(((0x200067a5) & (~0x3)) + 0x4)
...
#pragma section = "APP_STARTUP_SECTION"
#pragma location="APP_STARTUP_SECTION"
...
BOOL App_FlashIfFlashCheckAndConfigure();
...
#define WORD_ALIGNED_ADDR(a)         (((UINT32)(a) & (~0x3)) + 0x4)
...
//GsnFlashIfStartup_DmaCtlSet_Exit:
    return status;
}
